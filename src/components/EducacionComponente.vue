...
const educacion = ref([
  {fecha: '2025', title: 'Tecnicatura Universitaria en Programación', descripcion: 'Me encuentro actualmente cursando la Tecnicatura Universitaria en programacion, cuento con conocimientos en lenguajes como Python,JavaScrip y Java.'},
  {fecha: '2025', title: 'Testin QA Manual', descripcion: 'En dicho curso aprendí a la realización de casos de pruebas manuales,reporte de bugs, pruebas de rendimiento con Lighthouse, llamadas a APIS con Postman'},
  {fecha: '2024', title: 'Python para Análisis de Datos/ Data Analytics / Business Analytics /Data Science I', descripcion: 'Los cursos los realice para una formación en Analisis de datos, en los cursos aprendi a Manipular,limpiar y visualizar datos', enlace:'https://colab.research.google.com/drive/1vieLao-GM6XRP4mYWTvXgiZMc5Ft69UG?usp=sharing'},
  {fecha: '2023', title: 'Testing Funcional-Say Quality', descripcion: 'Realice un curso sobre testing funcional, realice testing de una página de ecommerce'},
