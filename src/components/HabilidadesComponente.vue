...
import img12 from '/src/components/icons/Pandas.svg';
import img13 from '/src/components/icons/Numpy.svg';
...
const habilidades = ref([
    ...
    },
    {
        id: 2, nombre: 'Frameworks y Librerías', habilidades: [
            { id: 1, nombre: 'Pandas', nivel: 'Básico', icono: img12},
            { id: 2, nombre: 'Vue.js', nivel: 'Básico', icono: img6 },
            { id: 3, nombre: 'Numpy', nivel: 'Básico', icono: img13}
        ]
    },
    {
        id: 3, nombre: 'Herramientas y Software', habilidades: [
            { id: 1, nombre: 'Git', nivel: 'Intermedio', icono: img7 },
            { id: 2, nombre: 'Visual Studio Code', nivel: 'Intermedio', icono: img8}
        ]
    },
    {
        id: 4, nombre: 'Bases de Datos', habilidades: [
            { id: 1, nombre: 'MySQL', nivel: 'Intermedio', icono: img9 },
    ...
    },
    {
        id: 5, nombre: 'Idiomas', habilidades: [
            ...
            { id: 2, nombre: 'Inglés', nivel: 'A2', icono: img11 }
        ]
    }
]);
